...
void convert_and_save_with_time_instance(const string& input_filename, const string& output_filename, int interval_minutes) {
...
int main() {
    ...
    string output_filename = "bitcoin-temporal-timeinstance.txt";
    int interval_minutes = 10;

    convert_and_save_with_time_instance(input_filename, output_filename, interval_minutes);
