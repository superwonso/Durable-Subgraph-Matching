...
public:
    ...
    MatchSummary save_res(
        const std::string& filename,
        MatchOutputMode mode = MatchOutputMode::Full) const;
...
private:
    ...
    CheckedMatchCounter enumerateMatches(
        std::ostream& output,
