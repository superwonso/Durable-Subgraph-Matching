...
private:
    ...
    std::unique_ptr<CandidateExpander> candidate_expander_;
    ...
    int getRootQueryVertex() const;
    std::vector<TDTreeNode*> buildNodeIndex() const;
    std::vector<int> buildTraversalOrder() const;
    std::vector<int> buildReverseTraversalOrder() const;
